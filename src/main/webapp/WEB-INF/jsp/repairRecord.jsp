        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Please fill out the repair record form: </h3>
                </div>
                <div class="panel-body">
                    <form role="form" method="post" action="/repairRecord">
                        <div class="row">
                            <div class="form-group">
                                <input type="hidden" id="repair_request_id" name="repair_request_id" value="${repairRequestId}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="number" name="work_price" id="work_price"
                                       class="form-control input-sm" placeholder="work_price">
                            </div>
                            <div class="form-group">
                                <input type="number" name="detail_price" id="detail_price"
                                       class="form-control input-sm" placeholder="detail_price">
                            </div>
                            <div class="form-group">
                                <input type="text" name="other_notes" id="other_notes"
                                       class="form-control input-sm" placeholder="other_notes">
                            </div>
                        </div>


                        <input type="submit" value="Complete repair record mark" class="btn btn-info btn-block">
                    </form>
                </div>
            </div>
        </div>
