        ...
        <div class="col-md-8 col-lg-9">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Add detail to catalog </h3>
                </div>
                <div class="panel-body">
                    <form role="form" method="post" action="/addDetailToCatalog">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input type="text" name="name" id="name" class="form-control input-sm" placeholder=" Detail name">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input type="text" name="price" id="price" class="form-control input-sm" placeholder=" Detail price">
                                </div>
                            </div>
                        </div>

                        <input type="submit" value="Add to catalog" class="btn btn-info btn-block" >
                    </form>
                </div>
            </div>
        </div>
