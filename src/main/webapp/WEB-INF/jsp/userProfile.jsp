            ...
            <c:if test="${currentUser.id != 0}">
                <div class="text-white">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="/userProfile" style="color:rgb(7, 246, 184 );">Hello, ${currentUser.login}</a></li>
...
<div class="container">
    <div class="row centered-form">
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4" id="allUserRepairRequestContainer">
            <c:forEach items="${userRepairRequests}" var="allUserRepairRequests">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">All repairs of ${currentUser.login} </h3>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="list-group">
                                    <a href="#" class="list-group-item active">Repair
                                        description:${allUserRepairRequests.repairDescription}</a>
                                    <a href="#" class="list-group-item ">Date:${allUserRepairRequests.dateOfRepair}</a>
                                    <a href="#" class="list-group-item active">Car:${allUserRepairRequests.carRemark}</a>
                                    <a href="#" class="list-group-item ">Status:${allUserRepairRequests.status}</a>
