    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <ul class="nav navbar-nav">
                <li><a href="/">Home</a></li>
                <li class="active"><a href="/allUserOrders">My Repairs</a></li>
...
<div class="container">
    <div class="row centered-form">
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4" id="allRepairRecordContainer">
            <c:forEach items="${repairRecordList}" var="currentUserOrder">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Repairs of ${currentUser.login} </h3>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="list-group">
                                    <a href="#" class="list-group-item active">User
                                        name: ${currentUserOrder.repairRequest.user.name}
                                            ${currentUserOrder.repairRequest.user.surname}</a>
                                    <a href="#" class="list-group-item ">User phone
                                        number: ${currentUserOrder.repairRequest.user.phoneNumber}</a>
                                    <a href="#" class="list-group-item active">Date of
                                        repair: ${currentUserOrder.repairRequest.dateOfRepair}</a>
                                    <a href="#" class="list-group-item ">Car
                                        description: ${currentUserOrder.repairRequest.repairDescription}</a>
                                    <a href="#" class="list-group-item active">Work
                                        price: ${currentUserOrder.workPrice}</a>
                                    <a href="#" class="list-group-item ">Detail
                                        price: ${currentUserOrder.detailPrice}</a>
                                    <a href="#"
                                       class="list-group-item active">OtherNotes: ${currentUserOrder.otherNotes}</a>
                                </div>
                                <hr>
                            </div>
                        </div>
